...
<body>
  ...
  <header class="header">
    ...
    <div class="main-body">
      ...
      <div class="list1">
        <form class="modal-content animate" action="controllers.php?act=update_goitap2" method="post" enctype="multipart/form-data">
          ...
          <div class="container">
            ...
            <input type="hidden" name="idgt" value="<?= $gtct[0]['id'] ?>">
            ...
            <label for="tenkh"><b>Địa chỉ</b></label>
            ...
            <input type="submit" name="updategoitap" value="Cập nhập" class="form-control text-bg-danger">
